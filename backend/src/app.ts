...
// Security middleware
// Allow CDN assets for the /api-docs page; use strict CSP everywhere else
...
// Swagger API documentation – CDN-based for Vercel/serverless compatibility
...
<html lang="en">
  <head>
    <title>Split It API Documentation</title>
    <meta charset="utf-8"/>
